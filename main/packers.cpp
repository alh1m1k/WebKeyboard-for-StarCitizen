...
wifi_auth_mode_t checkWifi(const wifi_auth_mode_t mode) noexcept {
	switch (mode) {          
...
settingsPack unpackSettings(const std::string_view rawMessage, const char separator) {
...
std::string resultMsg(const char* prefix, const std::string_view id, const bool status) {
...
std::string settingsGetMsg(const std::string_view id, const std::string& ssid, wifi_auth_mode_t authMode) {
...
//reason 3 - disconnect
std::string connectedNotify(const uint32_t packetId, const std::string& clientId, const int reason) {
...
std::string renameNotify(const uint32_t packetId, const std::string& clientName, const std::string& oldClientName) {
...
std::string signNotify(const uint32_t packetId, const std::string& ns, const std::string& sign) {
...
std::string settingsSetNotify(const uint32_t packetId) {
...
result<uint32_t> packetIdFromView(const std::string_view view) {
	uint32_t packetId = 0;
