...
enum
{
  REPORT_ID_GAMEPAD0 = HID_ITF_PROTOCOL_MOUSE + 1,
  REPORT_ID_GAMEPAD1,
  REPORT_ID_COUNT
};
...
#endif
#if INCLUDE_JOYSTICK0
    TUD_HID_REPORT_DESC_RCGAMEPAD(HID_REPORT_ID(REPORT_ID_GAMEPAD0)),
#endif
#if INCLUDE_JOYSTICK1
	TUD_HID_REPORT_DESC_RCGAMEPAD(HID_REPORT_ID(REPORT_ID_GAMEPAD1)),
#endif
};
